              ...
              <vs-table max-items="5" pagination :data="list">
                ...
                <template slot-scope="{data}">
                  <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td :data="tr.id">
                      <vs-avatar size="70px" :src="JSON.parse(tr.avatar)[0]" />
                    </vs-td>
                    <vs-td :data="tr.id" v-if="tr.status == 0">Ẩn</vs-td>
                    <vs-td :data="tr.id" v-if="tr.status == 1">Hiện bình thường</vs-td>
                    <vs-td :data="tr.id" v-if="tr.status == 2">Trang độc lập</vs-td>
                    <vs-td :data="tr.id">
